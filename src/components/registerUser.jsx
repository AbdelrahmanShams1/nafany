...
const RegisterUser = () => {
  ...
  const governorates = [
    ...
    "المنوفية", "القليوبية", "القليوبية", "البحيرة", "الغربية", "الفيوم",
    "كفر الشيخ", "المنيا", "أسيوط", "سوهاج", "قنا", "أسوان",
    "الأقصر", "بني سويف", "مطروح", "السويس", "الإسماعيلية",
    "بورسعيد", "دمياط", "البحر الأحمر", "الوادي الجديد", "شمال سيناء", "جنوب سيناء"
  ];
